...
def buy(ticker,shares,user_name):
    ...
    if(balance >= total_cost):
        ...
        return {"User" : user_name , "Ticker": ticker, "Shares": 0, "Cost" : "You dont have enough money to buy these shares"}
...
def sell(ticker, shares, user_name):
    ...
    if total_shares==False:
        return {"username":user_name, "Ticker": ticker, "Shares": 0, "Cost": "You do not have enough shares of "+str(ticker)}
